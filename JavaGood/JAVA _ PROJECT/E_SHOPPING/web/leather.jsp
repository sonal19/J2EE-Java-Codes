...
<img src="New Folder (3)/101926_Hansraj_HRM_M_1_2X.jpg" width="240" height="300" align="left">
<b><br><font size="+3" color="white">&nbsp;&nbsp;HRM Cricket Ball Practice Soft Cricket Ball</font>
...
<br>
&nbsp;&nbsp;<font color="red" size="+3">Rs 266</font>
<br>
&nbsp;&nbsp;
...
<%
 ...
 Connection con=DriverManager.getConnection("jdbc:odbc:mydata");		
		...
		ResultSet rs=st.executeQuery("select * from BALL where CBALL_ID=4");
		while(rs.next())
              {
                  i1=rs.getInt(1);  
                  s=rs.getString(3);
