...
<body>
 <jsp:include page="afterloginheader.jsp"/>
    ...
    <p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>
        ...
        <table width="1099" height="378" align="right"   >
            <tr><td><img src="New Folder (3)/SeG_Combo_20_M_1_2x.jpg" width="300" height="400" align="left">
<b><br><br><font size="+3" color="white">&nbsp;&nbsp;Cosco Cricket Tennis Tuff Balls (pack of 1 dozen)</font>
...
<p>&nbsp;</p>&nbsp;&nbsp;
<font color="red" size="+3">Rs 680</font></center>
<br>
&nbsp;&nbsp;
...
<%
 ...
 Connection con=DriverManager.getConnection("jdbc:odbc:mydata");		
		...
		ResultSet rs=st.executeQuery("select * from BALL where CBALL_NAME='Cosco Cricket Tennis Tuff Balls (pack of 1 dozen)'");
		while(rs.next())
              {
                  i1=rs.getInt(1); 
                  s=rs.getString(3);
...
</b><br><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>
<p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><br><p>&nbsp;</p><br><p>&nbsp;</p><br><p>&nbsp;</p><br><p>&nbsp;</p><br><p>&nbsp;</p>
