<%-- 
    Document   : head first java
    Created on : Aug 14, 2012, 12:54:34 AM
    Author     : chandan
--%>
...
<img src="images/head-first-java2.jpeg" width="300" height="400" align="left">
<b><font size="+3" color="white">&nbsp;&nbsp;HEAD FIRST JAVA</font>

    <ul ><font size="+2" color="white">

<li>&nbsp;&nbsp;&nbsp;By: Kathy Sierra & Bert Bates </li>
...
<li>pages:350</li>
 ...
 <p>&nbsp;</p>&nbsp;&nbsp;
<font color="red" size="+3">Rs 260</font>
<br>
...
<%
 ...
 Connection con=DriverManager.getConnection("jdbc:odbc:mydata");
		...
		ResultSet rs=st.executeQuery("select * from EDUCATIONAL where EBOOK_NAME='HEAD FIRST JAVA'");
		while(rs.next())
                    {
                  i1=rs.getInt(1);
                   s=rs.getString(3);
                ...
                session.setAttribute("head first java",i1);
