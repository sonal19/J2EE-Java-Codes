<%-- 
    Document   : wing of fire
    Created on : Aug 14, 2012, 12:46:53 PM
    Author     : chandan
--%>
...
<img src="images/wings-of-fire2.jpeg" width="300" height="400" align="left">
<b><font size="+3" color="white">&nbsp;&nbsp;WINGS OF FIRE</font>

    <ul ><font size="+2" color="white">

<li>&nbsp;&nbsp;&nbsp;By: Abdul kalam Azad with Arun Tiwary </li>
<li>BOOK: Novel </li>
...
<li>pages:250</li>
 ...
 <p>&nbsp;</p>&nbsp;&nbsp;
<font color="red" size="+3">Rs 193</font>
<br>
...
<%
 ...
 Connection con=DriverManager.getConnection("jdbc:odbc:mydata");
		...
		ResultSet rs=st.executeQuery("select * from NOVEL where NBOOK_ID=1");
		while(rs.next())
                    {
                  i1=rs.getInt(1);
                   s=rs.getString(3);
                ...
                out.println(i1);
                session.setAttribute("WINGS OF FIRE",i1);
