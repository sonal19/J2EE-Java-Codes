<%-- 
    Document   : valmiki ramayan
    Created on : Aug 14, 2012, 12:43:34 AM
    Author     : chandan
--%>
...
<img src="images/valmiki-s-ramayana2.jpeg" width="300" height="400" align="left">
<b><font size="+3" color="white">&nbsp;&nbsp; VALMIKI'S RAMAYAN</font>
...
<li>pages:140</li>
 ...
 <p>&nbsp;</p>&nbsp;&nbsp;
<font color="red" size="+3">Rs 90</font>
<br>


<%@page import="java.sql.*"%>
  <%! int i1,i2,d1,d2,d3,d4;
  String s;%>
<%
   try{
 ...
 Connection con=DriverManager.getConnection("jdbc:odbc:mydata");
		...
		ResultSet rs=st.executeQuery("select * from PRAYER  where PBOOK_NAME='VALMIKIS RAMAYAN' ");
		while(rs.next())
              {
                  i1=rs.getInt(1);
                   s=rs.getString(3);
