<%-- 
    Document   : white tiger
    Created on : Aug 14, 2012, 12:47:15 PM
    Author     : chandan
--%>
...
<img src="images/the-white-tiger2.jpeg" width="300" height="400" align="left">
<b><font size="+3" color="white">&nbsp;&nbsp;THE WHITE TIGER</font>

    <ul ><font size="+2" color="white">

<li>&nbsp;&nbsp;&nbsp;By: Arvind Adiga </li>
<li>BOOK: Novel </li>
...
<li>pages:250</li>
 ...
 <p>&nbsp;</p>&nbsp;&nbsp;
<font color="red" size="+3">Rs 209</font>
<br>
...
<%
 ...
 Connection con=DriverManager.getConnection("jdbc:odbc:mydata");
		...
		ResultSet rs=st.executeQuery("select * from NOVEL where NBOOK_NAME='THE WHITE TIGER'");
		while(rs.next())
                    {
                  i1=rs.getInt(1);
                   s=rs.getString(3);
                ...
                session.setAttribute("the white tiger",i1);
