<%-- 
    Document   : jeans3
    Created on : Aug 31, 2012, 3:20:37 PM
    Author     : chandan
--%>
...
<img src="images/12.PNG" width="300" height="400" align="left">
...
<li>Color: Dark blue,black</li>
 ...
 <p>&nbsp;</p>&nbsp;&nbsp;
<font color="red" size="+3">Rs 2000</font>
<br>
...
<%
 ...
 Connection con=DriverManager.getConnection("jdbc:odbc:mydata");
		...
		ResultSet rs=st.executeQuery("select * from JEANS where JEAN_ID=3");
		while(rs.next())
              {
                  i1=rs.getInt(1);
                  s=rs.getString(3);
