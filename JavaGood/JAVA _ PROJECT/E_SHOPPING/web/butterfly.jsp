...
<img src="New Folder (3)/Butterfly.jpg" width="300" height="300" align="left">
<b><font size="+3" color="white">&nbsp;&nbsp;Butterfly ACM-1000 Table Tennis Blade</font>

<ul><font size="+2" color="white">
<li>Brand: Butterfly </li>
<li>Sport: Table Tennis </li>
<li>Warranty:  Manufacturer repair/replacement warranty against rubber detachmen</li>
<li>Speed: 9</li>
<li>Weight: 250 grams </li></font>
</ul>

&nbsp;&nbsp;
<font color="red" size="+3">Rs 2400</font>
<br>
&nbsp;&nbsp;
...
<%
 ...
 Connection con=DriverManager.getConnection("jdbc:odbc:mydata");		
		...
		ResultSet rs=st.executeQuery("select * from TT_RACKET where FBAT_NAME='Butterfly ACM-1000 Table Tennis Blade'");
		while(rs.next())
              {
                  i1=rs.getInt(1);
                  s=rs.getString(3);
                ...
                session.setAttribute("butterfly",i1);
...
<br><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>
