<%-- <head>
        ...
        <t
    Document   : java complete reference
    Created on : Aug 14, 2012, 12:55:05 AM
    Author     : chandan
--%>
...
<img src="images/java-the-complete-reference2.jpeg" width="300" height="400" align="left">
<b><font size="+3" color="white">&nbsp;&nbsp;JAVA: COMPLETE REFERENCE</font>

    <ul ><font size="+2" color="white">

<li>&nbsp;&nbsp;&nbsp;By: Herbert Schildt </li>
...
<li>pages:450</li>
 ...
 <p>&nbsp;</p>&nbsp;&nbsp;
<font color="red" size="+3">Rs 550</font>
<br>
...
<%
 ...
 Connection con=DriverManager.getConnection("jdbc:odbc:mydata");
		...
		ResultSet rs=st.executeQuery("select * from EDUCATIONAL where EBOOK_NAME='JAVA:Complete Reference'");
		while(rs.next())
                    {
                  i1=rs.getInt(1);
                   s=rs.getString(3);
                ...
                session.setAttribute("JAVA COMPLETE REFERENCE",i1);
