<%-- 
    Document   : jeans2
    Created on : Aug 31, 2012, 3:20:20 PM
    Author     : chandan
--%>
...
<img src="images/11.PNG" width="300" height="400" align="left">
<b><font size="+3" color="white">&nbsp;&nbsp;DETAILS</font>

    <ul ><font size="+2" color="white">

<li>BRAND: FLYING MACHINE </li>
<li>Size: 32,34,36</li>
<li>Color: Dark blue,black</li>
 ...
 <p>&nbsp;</p>&nbsp;&nbsp;
<font color="red" size="+3">Rs 1469</font>
<br>
...
<%
 ...
 Connection con=DriverManager.getConnection("jdbc:odbc:mydata");
		...
		ResultSet rs=st.executeQuery("select * from JEANS where JEAN_ID=2");
		while(rs.next())
              {
                  i1=rs.getInt(1);
                  s=rs.getString(3);
