<%-- 
    Document   : bhagwat geeta
    Created on : Aug 14, 2012, 12:44:11 AM
    Author     : chandan
--%>
...
<img src="images/bhagwat geeta2.jpeg" width="300" height="400" align="left">
<b><font size="+3" color="white">&nbsp;&nbsp;BHAGWAT GEETA</font>

    <ul ><font size="+2" color="white">
          
<li>&nbsp;&nbsp;&nbsp;By: Sant Dnyaneshwar </li>
...
<%
 ...
 Connection con=DriverManager.getConnection("jdbc:odbc:mydata");
		...
		ResultSet rs=st.executeQuery("select * from PRAYER  where PBOOK_NAME='BHAGWAT GEETA' ");
		while(rs.next())
              {
                  i1=rs.getInt(1);
                   s=rs.getString(3);
