<%-- 
    Document   : jeans4
    Created on : Aug 31, 2012, 3:20:54 PM
    Author     : chandan
--%>
...
<img src="images/13.PNG" width="300" height="400" align="left">
...
<%
 ...
 Connection con=DriverManager.getConnection("jdbc:odbc:mydata");
		...
		ResultSet rs=st.executeQuery("select * from JEANS where JEAN_ID=4");
		while(rs.next())
              {
                  i1=rs.getInt(1);
                  s=rs.getString(3);
