...
<img src="New Folder (3)/racket2.jpg" width="250" height="300" align="left">
<b><font size="+3" color="white">&nbsp;&nbsp;Joola Smash Recreational Table Tennis Racket</font>
...
<li>Speed: 8</li>
<li>Weight: 160 grams </li></font>
</ul>

&nbsp;&nbsp;
<font color="red" size="+3">Rs 1499</font>
<br>
...
<%
 ...
 Connection con=DriverManager.getConnection("jdbc:odbc:mydata");		
		...
		ResultSet rs=st.executeQuery("select * from TT_RACKET where FBAT_NAME='Joola Smash Recreational Table Tennis Racket' ");
		while(rs.next())
              {
                  i1=rs.getInt(1);                  
                  s=rs.getString(3);
                ...
                session.setAttribute("racket2",i1);
