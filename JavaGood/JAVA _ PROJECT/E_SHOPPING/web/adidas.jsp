...
<img src="New Folder (3)/BAT/ADIDAS.jpg" width="300" height="400" align="left">
<b><font size="+3" color="white">&nbsp;&nbsp;Adidas Incurza Elite Cricket Bat</font>
...
<p>&nbsp;</p>&nbsp;&nbsp;
<font color="red" size="+3">Rs 1699</font>
<br>
&nbsp;&nbsp;
...
<%
 ...
 Connection con=DriverManager.getConnection("jdbc:odbc:mydata");		
		...
		ResultSet rs=st.executeQuery("select * from BAT where CBAT_ID=4");
		while(rs.next())
              {
                  i1=rs.getInt(1);
                   s=rs.getString(3);
                ...
                session.setAttribute("adidas",i1);
