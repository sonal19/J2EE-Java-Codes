<%-- 
    Document   : i too had a love story
    Created on : Aug 14, 2012, 12:48:53 PM
    Author     : chandan
--%>
...
<img src="images/i-too-had-a-love-story2.jpeg" width="300" height="400" align="left">
<b><font size="+3" color="white">&nbsp;&nbsp;I TOO HAD A LOVE STORY</font>

    <ul ><font size="+2" color="white">

<li>&nbsp;&nbsp;&nbsp;By: Ravinder Singh</li>
<li>BOOK: Novel </li>
...
<li>pages:250</li>
 ...
 <p>&nbsp;</p>&nbsp;&nbsp;
<font color="red" size="+3">Rs 130</font>
<br>
...
<%
 ...
 Connection con=DriverManager.getConnection("jdbc:odbc:mydata");
		...
		ResultSet rs=st.executeQuery("select * from NOVEL where NBOOK_NAME='I TOO HAD A LOVE STORIES'");
		while(rs.next())
                    {
                  i1=rs.getInt(1);
                   s=rs.getString(3);
                ...
                session.setAttribute("i too had a love stories",i1);
