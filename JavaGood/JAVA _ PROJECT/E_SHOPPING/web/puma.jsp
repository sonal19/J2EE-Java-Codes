...
<img src="New Folder (3)/BAT/PUMA.jpg" width="300" height="400" align="left">
<b><font size="+3" color="white">&nbsp;&nbsp;Puma Calibre Blast Cricket Bat</font>
...
<li>Size: SH</li>
    ...
    <p>&nbsp;</p>&nbsp;&nbsp;
<font color="red" size="+3">Rs 1599</font>
<br>
&nbsp;&nbsp;
...
<%
 ...
 Connection con=DriverManager.getConnection("jdbc:odbc:mydata");		
		...
		ResultSet rs=st.executeQuery("select * from BAT where CBAT_NAME='Puma Calibre Blast Cricket Bat' ");
		while(rs.next())
              {
                  i1=rs.getInt(1);
...
<form action="Cart.jsp">
    ...
    <a href=dwnld.jsp?link=<%out.println(i1);%>><button>Download Image</button></a></td></tr></table>
