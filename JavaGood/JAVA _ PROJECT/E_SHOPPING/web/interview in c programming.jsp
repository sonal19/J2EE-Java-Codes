<%-- 
    Document   : interview in c programming
    Created on : Aug 14, 2012, 12:56:05 AM
    Author     : chandan
--%>
...
<img src="images/interview-questions-in-c-programming2.jpeg" width="300" height="400" align="left">
<b><font size="+3" color="white">&nbsp;&nbsp;INTERVIEW QUESTION IN C PROGRAMMING</font>

    <ul ><font size="+2" color="white">

<li>&nbsp;&nbsp;&nbsp;By: Yashwant Kanetkar </li>
...
<li>pages:250</li>
 ...
 <p>&nbsp;</p>&nbsp;&nbsp;
<font color="red" size="+3">Rs 400</font>
<br>
...
<%
 ...
 Connection con=DriverManager.getConnection("jdbc:odbc:mydata");
		...
		ResultSet rs=st.executeQuery("select * from EDUCATIONAL where EBOOK_NAME='INTERVIEW QUESTION IN C PROGRAMMING'");
		while(rs.next())
                    {
                  i1=rs.getInt(1);
                   s=rs.getString(3);
                ...
                session.setAttribute("interview question in c programming",i1);
