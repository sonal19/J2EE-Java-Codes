<%-- 
    Document   : tshirt4
    Created on : Aug 31, 2012, 3:52:11 PM
    Author     : chandan
--%>
...
<img src="images/21.PNG" width="300" height="400" align="left">
...
<li>BRAND: PUMA </li>
<li>Size: 90</li>
<li>Color: Dark blue,black,white</li>
</font>
</ul>

 <p>&nbsp;</p>&nbsp;&nbsp;
<font color="red" size="+3">Rs 689</font>
<br>
...
<%
 ...
 Connection con=DriverManager.getConnection("jdbc:odbc:mydata");
		...
		ResultSet rs=st.executeQuery("select * from TSHIRT where BRAND_NAME='Puma'");
		while(rs.next())
              {
                  i1=rs.getInt(1);
                   s=rs.getString(3);
                ...
                session.setAttribute("tshirt5",i1);
                d1=(Integer)session.getAttribute("garment");
                d2=(Integer)session.getAttribute("tshirt");
%>
