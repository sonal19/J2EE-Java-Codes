<%-- 
    Document   : tshirt3
    Created on : Aug 31, 2012, 3:51:56 PM
    Author     : chandan
--%>
...
<img src="images/24.PNG" width="300" height="400" align="left">
...
<li>Color: Dark blue,black</li>
 ...
 <p>&nbsp;</p>&nbsp;&nbsp;
<font color="red" size="+3">Rs 499</font>
<br>
...
<%
 ...
 Connection con=DriverManager.getConnection("jdbc:odbc:mydata");
		...
		ResultSet rs=st.executeQuery("select * from TSHIRT where BRAND_NAME='Reebok'");
		while(rs.next())
              {
                  i1=rs.getInt(1);
                   s=rs.getString(3);
                ...
                session.setAttribute("tshirt4",i1);
