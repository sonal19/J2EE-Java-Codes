...
/**
 * The Class DirectoryWatcher which continuously monitors the directory and will
 * start the thread if any events occurs in that directory
 * 
 * @author ricktamkundu
 */
public class DirectoryWatcher {
	...
	/**
	 * Directory watch keep the watch on the directory perform create modify and
	 * delete operation.
	 *
	 * @param path
	...
	public static Map directoryWatch(final String path, final Map fileMapper) throws UserExceptionClass {
