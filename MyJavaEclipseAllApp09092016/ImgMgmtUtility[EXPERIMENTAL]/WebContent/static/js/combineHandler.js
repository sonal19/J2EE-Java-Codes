...
function TogglePopup() {
	...
	/*$('tr,td').each(function () {
        //Reference the Label.
        var label = $(this).closest('tr').find('td:nth-child(1)').html($('#txtName').val("sasa"));
        var label1 = $(this).closest('tr').find('td:nth-child(2)').html("<input type = 'text' />");
        var label2 = $(this).closest('tr').find('td:nth-child(3)').html("<input type = 'text' />");
        var label3 = $(this).closest('tr').find('td:nth-child(4)').html("<input type = 'text' />");html("<input type = 'text' />");
 
        //Add a TextBox next to the Label.
        label.after("<input type = 'text' style = 'display:none' />");
      //Add a TextBox next to the Label.
        label1.after("<input type = 'text' style = 'display:none' />");
      //Add a TextBox next to the Label.
        label2.after("<input type = 'text' style = 'display:none' />");
      //Add a TextBox next to the Label.
        label3.after("<input type = 'text' style = 'display:none' />");
