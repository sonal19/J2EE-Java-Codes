...
$.fn.tableEdit = function(settings, callback, activeMasks) {
	...
	//var img=eval("<img src='../static/images/edit.png' />");
	 var defaults = {
        ...
        textBtSave:"<span class='action' action='Edit'><img	src='../static/images/save.ico' /></span>", //text button save
        textBtEdit: "<span class='action' action='Edit'><img	src='../static/images/edit.png' /></span>", //text button edit
    ...
    return this.each(function() {
        ...
        function changeBt(bt)
        {
            ...
            $(bt).html(((hasClass) ? settings.textBtSave : settings.textBtEdit));
