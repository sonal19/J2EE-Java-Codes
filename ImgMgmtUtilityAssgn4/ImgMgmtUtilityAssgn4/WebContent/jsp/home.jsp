...
<c:forEach items="${requestScope.imageData}" var="emp">
<tr><td><c:out value="${emp.userId}"></c:out></td>
<td><c:out value="${emp.name}"></c:out></td>
<td><c:out value="${emp.size}"></c:out></td>
<td><img src="${pageContext.servletContext.contextPath }/RetreiveImageServlet" width="100" height="100"/></td></tr>
</c:forEach>
</tbody>
</table>
<br><br>
